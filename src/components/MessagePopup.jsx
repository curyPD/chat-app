...
export default function MessagePopup(props) {
    return (
        <Overlay onClick={props.closePopup}>
            <div className="fixed top-1/2 left-1/2 z-50 w-52 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white pt-4 pb-2 shadow-md md:pb-3 md:pt-5 lg:w-60 lg:pt-6">
                <button
                ...
                <button
                    className="flex w-full items-center gap-5 py-3 px-5 hover:bg-slate-50 lg:px-6"
