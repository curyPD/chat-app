...
export default function FirstMessageDialogWindow(props) {
    ...
    return (
        <Overlay onClick={props.closeDialog}>
            <div className="fixed top-1/2 left-1/2 z-50 w-10/12 max-w-xs -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white px-4 pt-4 pb-2 shadow-md md:max-w-sm md:px-5 md:pt-5 md:pb-3 lg:max-w-md lg:px-6 lg:pt-6">
                <button
