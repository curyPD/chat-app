...
export default function MobileNav() {
    return (
        <footer className="fixed bottom-0 left-0 z-10 h-12 w-full md:h-full md:w-14 lg:hidden">
            <nav className="flex h-full items-center justify-evenly border-t border-slate-200 bg-white px-4 dark:border-slate-800 dark:bg-[#0b101d] md:flex-col-reverse md:justify-end md:gap-9 md:border-t-0 md:border-r md:px-0 md:pt-4">
