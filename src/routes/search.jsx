...
export default function Search() {
    ...
    return (
        <>
            <header className="fixed top-0 left-0 z-10 w-full border-b border-slate-200 bg-white px-6 shadow-sm sm:px-8 md:ml-14 md:w-fixed-bar-tablet md:px-6">
                <Form
                ...
                >
                    <input
                        ...
                        className="w-full rounded-full border border-slate-100 bg-white py-1.5 px-4 text-sm text-slate-700 shadow placeholder:text-slate-300 focus:border-sky-300 focus:outline-none focus:ring-1 focus:ring-sky-300"
            ...
            {!searchTerm ? (
                ...
                <main className="pb-12 pt-16 md:ml-14 md:pb-0">
                    <ol className="py-6">{userElements}</ol>
                </main>
            ) : (
                <div className="flex h-full flex-col items-center justify-center gap-4">
                    <img src={logo} alt="Logo" className="h-8 w-8 shrink-0" />
