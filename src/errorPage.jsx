            ...
            return (
                <main className="flex h-screen items-center justify-center bg-custom-gradient">
                    <div className="-mt-16 max-w-screen-lg px-8 text-center">
                        ...
                        <p className="mb-7 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-7xl font-black text-transparent lg:text-8xl">
                            {error.status}
                        </p>
                        <h2 className="mb-12 text-lg font-bold text-slate-900 lg:mb-14 lg:text-xl">
